...
describe('getDigit', function () {
  ...
  it('should return the correct digit for positive integers', function () {
    ...
    expect(getDigit(8987, 0)).toBe(7);
    expect(getDigit(8987, 1)).toBe(8);
    expect(getDigit(8987, 2)).toBe(9);
    expect(getDigit(8987, 3)).toBe(8);
    expect(getDigit(8987, 4)).toBe(0);
  });
});
...
describe('digitCount', function () {
  ...
  it('should return the correct count for positive integers', function () {
    ...
    expect(digitCount(25)).toBe(2);
    expect(digitCount(314)).toBe(3);
    expect(digitCount(9)).toBe(1);
    expect(digitCount(77777)).toBe(5);
...
describe('mostDigits', function () {
  it('should exist', function () {
    expect(typeof mostDigits).toBe('function');
  });

  it('should return the correct count for arrays of positive integers', function () {
    expect(mostDigits([1, 9, 10, 100, 99])).toBe(3);
    expect(mostDigits([100, 1010, 1, 500])).toBe(4);
    expect(mostDigits([0, 100000, 400, 12, 8])).toBe(6);
  });
